...
const UpdateDesa = () => {
  ...
  const initialValues = {
    ...
    daerah_id: dataBalikan?.detailData?.data_daerah?.id ?? "",
    nama_desa: dataBalikan?.detailData?.nama_desa ?? "",
          ...
          <Form>
            ...
            >
              ...
              <div className="flex flex-col gap-3 p-4 sm:p-6">
                ...
                <div className="flex flex-col gap-2">
                  <label className={THEME_COLORS.text.label}>Daerah Asal</label>
                  <Select
                    id="daerah_id"
                    name="daerah_id"
                    value={
