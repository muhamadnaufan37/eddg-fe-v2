...
export const routes: TRoute[] = [
  ...
  },
  {
    ...
    layout: Layout,
    guard: AuthGuard,
    path: "/laporan-bulanan/monitoring-users",
    role: ["admin"],
    element: React.lazy(() => import("../pages/digital-data/monitoring-users")),
    fullScreen: false,
  },
  {
    exact: true,
  ...
  },
  {
    ...
    path: "/presensi",
    role: ["admin", "ptgs-sensus"],
    element: React.lazy(() => import("../pages/presensi")),
    fullScreen: false,
  },
  {
    exact: true,
    layout: Layout,
    guard: AuthGuard,
    path: "/presensi/peserta/:id_kegiatan/:kode_kegiatan",
    role: ["admin", "ptgs-sensus"],
    element: React.lazy(() => import("../pages/presensi/presensi-peserta")),
    fullScreen: false,
  },
  {
    exact: true,
    layout: Layout,
    guard: AuthGuard,
    path: "/presensi/list/:id_kegiatan/:kode_kegiatan",
    role: ["admin", "ptgs-sensus"],
    element: React.lazy(() => import("../pages/presensi/presensi-list")),
    fullScreen: false,
  },
  {
    exact: true,
    ...
    path: "/pengaduan",
    role: ["admin"],
    element: React.lazy(() => import("../pages/pengaduan")),
    fullScreen: false,
  },
  {
    exact: true,
    ...
    role: ["admin"],
    element: React.lazy(
      () => import("../pages/pengaduan/modal/CreatePengaduan"),
    ),
    fullScreen: false,
  },
  {
    ...
    role: ["admin"],
    element: React.lazy(
      () => import("../pages/pengaduan/modal/DetailPengaduan"),
    ),
    fullScreen: false,
  },
  {
    ...
    layout: Layout,
    guard: AuthGuard,
    path: "/pengaduan/update",
    role: ["admin"],
    element: React.lazy(
      () => import("../pages/pengaduan/modal/UpdatePengaduan"),
    ),
    fullScreen: false,
  },
  {
    ...
    layout: Layout,
    guard: AuthGuard,
    path: "/pengaduan/reply",
    role: ["admin"],
    element: React.lazy(
      () => import("../pages/pengaduan/modal/ReplyPengaduan"),
    ),
    fullScreen: false,
  },
  {
